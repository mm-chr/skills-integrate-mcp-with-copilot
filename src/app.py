...
def authenticate_teacher(credentials: HTTPBasicCredentials = Depends(security)):
    """Allow only configured teachers to change activity registrations."""
...
activities = {
    ...
    "GitHub Skills": {
        "description": "Learn practical coding, collaboration, and GitHub workflow skills through a hands-on certification pathway",
